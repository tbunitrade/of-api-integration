...
const itemLabel = computed(() =>
  props.item.isCurrentUser ? `${user.firstName} ${user.lastName}` : props.item.label
);
...
<template>
  ...
  <component :is="is" v-else ref="root" class="block lg:flex items-center relative cursor-pointer"
    ...
    <div v-if="item.menu"
      class="text-sm border-b border-gray-100 lg:border lg:bg-white lg:absolute lg:top-full lg:left-0 lg:min-w-full lg:z-20 lg:rounded-lg lg:shadow-lg lg:dark:bg-slate-800 dark:border-slate-700 max-h-[500px] overflow-auto"
