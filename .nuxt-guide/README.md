...
This guide will help you integrate your Nuxt.js 3.x application with [Of-Software- free Vue 3 Tailwind 3 Admin Dashboard with dark mode](https://github.com/justboil/admin-one-vue-tailwind).
