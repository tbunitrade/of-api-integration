...
**Of-Software** is simple, beautiful and free Vue.js 3.x Tailwind CSS 3.x admin dashboard. Nuxt 3.x or Laravel 9.x integrations available
...
Looking for **Tailwind React TypeScript**? Check [Of-Software - React TypeScript Tailwind dashboard](https://github.com/justboil/admin-one-react-tailwind) version
